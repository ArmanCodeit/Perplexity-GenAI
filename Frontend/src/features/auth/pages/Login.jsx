    ...
    <div className="min-h-screen bg-slate-950 text-white flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-md rounded-3xl border border-[#31b8c6]/20 bg-[#0d111b]/90 p-8 shadow-[0_20px_80px_rgba(49,184,198,0.18)] backdrop-blur-xl">
        <div className="mb-8 text-center">
          <p className="text-sm uppercase tracking-[0.35em] text-[#31b8c6]/80">Welcome back</p>
          <h1 className="mt-3 text-3xl font-semibold text-white">Login to your account</h1>
          <p className="mt-2 text-sm text-slate-400">Use your email and password to sign in.</p>
        </div>
        ...
        <div className="mt-6 text-center text-sm text-slate-400">
          ...
          <Link to="/register" className="font-semibold text-[#31b8c6] hover:text-[#66d9e4]">
            Register
          </Link>
        </div>
      </div>
